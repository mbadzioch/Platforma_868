...
/* Pin settings */
#define ONEWIRE_LOW()			GPIO_ResetBits(GPIOB,GPIO_Pin_6)
#define ONEWIRE_HIGH()			GPIO_SetBits(GPIOB,GPIO_Pin_6)
#define ONEWIRE_INPUT()			MB_GPIO_SetPinAsInput()
#define ONEWIRE_OUTPUT()		MB_GPIO_SetPinAsOutput()
